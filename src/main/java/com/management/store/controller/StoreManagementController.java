...
public class StoreManagementController {
    ...
    public boolean replaceProduct(@RequestBody Product product, @PathVariable Long id){
        return storeManagementService.updateProduct(product, id);
    }

    @PutMapping("/products/price/{id}")
    public boolean updatePrice(@RequestBody Double price, @PathVariable Long id){
        return storeManagementService.updatePrice(price, id);
    }

    @PutMapping("/products/quantity/{id}")
    public boolean updateQuantity(@RequestBody Integer quantity, @PathVariable Long id){
